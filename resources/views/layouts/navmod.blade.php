...
<div id="form">
		<form method="post"  role="from" action="{{route('update/pensamiento')}}" style="display:none" >
			@csrf
				...
				<input type="text" id="id_Planeacionn" name="id_Planeacionn"   >
...
<div class="menu_header">
	...
	<nav class="SegundoConten">
		<a  class="clos" aria-label="Close"><span class="icon-undo2"></span></a>
		<br>
...
<script>
	var nombre_proyecto = localStorage.getItem('nombre_proyecto');
	var id_Planeacionn = localStorage.getItem('id');
	$('#nombre_proyecto').val(nombre_proyecto);
	$('#nombre_proyecto2').html(id_Planeacionn);
	$('#nombre_proyecto3').html(id_Planeacionn);
