...
<br><br><br><br>
<!-- Agrega clase en el botón -->
<div class="menu_header btnHeaderMod3">
	<input type="checkbox" id="btn-menu">
	<label for="btn-menu"><span class="icon-list2" style="color: white;"></span></label>
	<!-- Agrega clase en el nav -->
	<nav class="Tercer_Contenedor navLateralMod3">
		@yield('f')
		<br>
		<h4 class="pensamiento">Indicadores de Objetivos</h4>
		<ul class="items3" style="padding: 110px 0px;">
			<li ><a   href="{{ route('vista1-2') }}" ><h6 style="line-height: 25px; font-size: 17px;">Diseño de Indicadores</h6><span class="rounded-circle3">1</span></a></li>

			<li ><a href="{{ route('vista2-1') }}"  id="linkid"><h6 style="line-height: 25px; font-size: 17px;">Resumen de Indicadores</h6><span class="rounded-circle3">2</span></a></li>
		</ul>
		<a id="botonn" value="Exportar"  class="siguienteMod3 exportar btn btn-planeem waves-effect waves-light">Exportar</a>
...
<script>
	...
	var link="Exportarr/"+id_Planeacion;
 	$('#botonn').attr('href', link);
