...
@section('content')
            ...
            <div>
                ...
                <div>
                    <p class="desafiante"><b style="color: #0AB5A0">Horizonte de tiempo:</b><br>
                        ...
                        se estipula que debe oscilar entre 7 y 10 años.<br><br>
    ...
    <script>
        ...
        function paso1(){
            ...
            document.getElementById('paso2').style.display = 'none';
            document.getElementById('paso3').style.display = 'none';
            id=  document.getElementById('por').style.width='25%';
        ...
        function paso2(){
            ...
            if(Mega == ""){
                ...
                document.getElementById('paso3').style.display = 'none';
                document.getElementById('alert').style.display = 'none';
                id=  document.getElementById('por').style.width='50%';
        ...
        function paso3(){
            ...
            if(Mega == ""){
                ...
                document.getElementById('alert').style.display = 'none';
                id=  document.getElementById('por').style.width='100%';
            }
