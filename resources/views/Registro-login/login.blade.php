...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content" id='ejemplo' >
        ...
        <div class="modal-header text-center">
            <h4 class="modal-title w-100 font-weight-bold" style="font-size: 21px">{{ __('Login') }}</h4>
            <!-- Correcioninicio1-1 -->
            <a class="close" href="{{ route('Inicio') }}" ><span class="icon-undo2" style="color: white;"></span></a>
            <!-- Correcioninicio -->
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="{{ route('login','#login') }}" id="asd" class="needs-validation" novalidate>
                ...
                <div class=" col-md-8 offset-md-2">
                    ...
                    <!-- Correcioninicio -->
                        <i class="glyphicon icon-user " style="color:black; padding: 13px"></i>

                        <!-- Correcioninicio1-1 -->
                        <input id="login" type="login"
                        class="form-control inicioformulario" name="login" value="{{ old('login') }}" placeholder="E-Mail o Usuario" required
    ...
    <div class="">
        ...
        <div class="text-center">
             <a class="btn btn-link" href="{{ route('password.request') }}" style="color:white !important;">Recuperar contraseña</a>

        <div class="cambiarfont">
            <a class="nav-link"  href="{{ route('Registro') }}">Regístrate</a>
        </div>
    </div>
</div>
</form>
